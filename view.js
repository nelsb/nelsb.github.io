...
(function () {
  ...
  view = {
    ...
    getModelRefY: function (pixelY) {
      return view.getModelCoordY(Math.floor((pixelY - view.borderWidth) / (view.cell.height + view.borderWidth)));
    },
    getModelRefX: function (pixelX) {
      return view.getModelCoordX(Math.floor((pixelX - view.borderWidth) / (view.cell.width + view.borderWidth)));
    },
